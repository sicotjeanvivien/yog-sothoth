...
│   ├── pool_account/      (DecodedPoolAccount = neutral PoolAccountCore +
│   │                       two-level PoolAccountProperties; PoolAccountResolver)
